...
class ModelSaleOrder extends Model {
    ...
    public function getProductOrders($order_product_id) {
       $sql = "SELECT o.order_id, CONCAT(o.firstname, ' ', o.lastname) AS customer,o.customer_id,
                (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '1') 
                ...
                where product_id =  '" . (int)$order_product_id . "'";
	    $query = $this->db->query($sql);
