...
class ControllerExtensionModuleBlogger extends Controller {
	public function index($setting) {
		...
		foreach ($this->model_pixo_blogger->getBlogsByModule($setting['module_id'], $setting['limit']) as $result) {			
			
			$total_comments = $this->model_pixo_blogger->getTotalBlogComments($result['blogger_id']);
